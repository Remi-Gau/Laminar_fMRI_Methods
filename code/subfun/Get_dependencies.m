...
% addpath(genpath(fullfile(Dir, 'GitHub', 'rsatoolbox')))
% addpath(genpath(fullfile(Dir, 'GitHub', 'plot_tools', 'color_maps')))
% addpath(genpath(fullfile(Dir, 'GitHub', 'matlab_for_cbs_tools')))
